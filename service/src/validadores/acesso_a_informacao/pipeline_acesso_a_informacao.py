...
def pipeline_acesso_a_informacao(keywords, job_name):
    ...
    acesso_a_informacao['dados_abertos'] = validador_dados_abertos.predict()

    # Subtag - Requisitos Exigios
    # validador_requisitos_exigidos = ValidadorRequisitosExigidos(job_name, keywords['requisitos_exigidos'])
    # acesso_a_informacao['requisitos_exigidos] = validador_requisitos_exigidos.predict()
    ...
    # acesso_a_informacao['relatorio_estatistico'] = validador_relatorio_estatistico.predict()
