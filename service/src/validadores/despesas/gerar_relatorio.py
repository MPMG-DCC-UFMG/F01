...
class ValidadorGerarRelatorios(Validador):
    ...
    def predict(self):
        ...
        resultados_gerar_relatorios['gerar_relatorios']['predict'] = isvalid
        resultados_gerar_relatorios['gerar_relatorios']['explain'] = result_explain

        return resultados_gerar_relatorios
