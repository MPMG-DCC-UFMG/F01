...
def main():
    dados_portal = pd.read_csv("Governador Valadares/dados-processados/rec-extraorcamentarias.csv")
    dados_api = pd.read_csv("Governador Valadares/API/orcamentaria/extras.csv")   
    
    dados_portal = convert_date(df=dados_portal, column_name='Data')
