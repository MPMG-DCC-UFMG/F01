...
from acesso_a_informacao import informacoes
from acesso_a_informacao import base_dados
import licitacoes 
import constant
...
def pipeline_informacoes(keywords, path_base, num_matches, job_name, verbose=False):
    ...
    # isvalid, result = informacoes.predict_link_portal(path_base = path_base, num_matches = 60 ,job_name='index_governador_valadares')
    # informacoes.explain_link_portal(isvalid, result)


    # Bases de dados abertos
    isvalid, result = base_dados.predict_bases_de_dados_abertos(path_base = path_base, job_name='index_governador_valadares')
    base_dados.explain_bases_de_dados_abertos(isvalid, result)
...
pipeline_informacoes(path_base)
