keywords = {
    ...
    'address': {
        'search_term':'page-principal', 
        'keywords':["Fale com a Prefeitura", "informações", "Ouvidoria", 'Telefone', 'Endereço', 'Email']},
    'accessibility': {
        'search_term':'acessibilidade', 
        'keywords':['Acessibilidade', 'decreto nº 7.724', 'acessibilidade na divulgação das informações',
    'opção de contraste', 'trabalhar com leitores de páginas']},
    'update_infos': {
        'search_term':'page-principal', 
        'keywords':['atualizado', 'update']},
    'search_engine': {
        'search_term':'page-principal', 
...
keywords_uberaba = {
    ...
    'update_infos': {
        'search_term':'Portal da Transparência', 
        'keywords':['Portal atualizado em', 'atualizado', 'update']},
    'search_engine': {
        'search_term':'Portal da Transparência', 
...
keywords_paracatu = {
    'export_reports': {
        'search_term':'Portal da Transparência · Paracatu', 
        'keywords':['pdf', 'xml', 'csv', 'xls', 'download', 'baixar', 'export', 'exportar']},
    'address': {
        'search_term':'Portal da Transparência · Paracatu', 
        'keywords':["Fale com a Prefeitura", "informações", "Ouvidoria", 'Telefone', 'Endereço', 'Email']},
