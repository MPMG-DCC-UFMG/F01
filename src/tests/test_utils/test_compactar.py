...
# F01/src$ python -m unittest tests.test_utils.test_compactar

BASE_PATH = Path(os.getcwd()) / 'tests/test_utils/test_compactar_arquivos'
...
class TestCompactar(unittest.TestCase):
    ...
    def test_extrair_arquivos_rar_com_extensao(self):
        ...
        result = [x.replace(os.getcwd() + '/tests/test_utils/test_compactar_arquivos/result_extrair/rar/com_extensao/', '') for x in files]
    ...
    def test_extrair_arquivos_rar_sem_extensao(self):
        ...
        result = [x.replace(os.getcwd() + '/tests/test_utils/test_compactar_arquivos/result_extrair/rar/sem_extensao/', '') for x in files]
    ...
    def test_extrair_arquivos_zip_com_extensao(self):
        ...
        result = [x.replace(os.getcwd() + '/tests/test_utils/test_compactar_arquivos/result_extrair/zip/com_extensao/', '') for x in files]
        expected = ['dados01/workspace/ufmg_2021_f01/ufmg.amedeiros/F01/src/tests/test_utils/test_compactar_arquivos/test_compactar/pdf_file_test.pdf', 'dados01/workspace/ufmg_2021_f01/ufmg.amedeiros/F01/src/tests/test_utils/test_compactar_arquivos/test_compactar/xlsx_files_test.xlsx', 'dados01/workspace/ufmg_2021_f01/ufmg.amedeiros/F01/src/tests/test_utils/test_compactar_arquivos/test_compactar/test_licitacoes.py']
    ...
    def test_extrair_arquivos_zip_sem_extensao(self):
        ...
        result = [x.replace(os.getcwd() + '/tests/test_utils/test_compactar_arquivos/result_extrair/zip/sem_extensao' + os.getcwd(), '') for x in files]
