...
#     municipio_directory = Path.home() / ".fscrawler" / municipio
...
#                 yaml.dump(config, yaml_file, default_flow_style=False)
    ...
    # subprocess.call(["/home/asafe/Desktop/SearchEngine/fscrawler-es7-2.8-SNAPSHOT/bin/fscrawler", municipio, "&"], shell=True)

    # subprocess.Popen(["/dados01/workspace/ufmg_2021_f01/ufmg.amedeiros/search_engine/fscrawler-es7-2.9/bin/fscrawler", municipio])
    # subprocess.Popen(["/dados01/workspace/ufmg_2021_f01/ufmg.amedeiros/", municipio])
